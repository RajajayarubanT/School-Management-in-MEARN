                ...
                <div className="container">
                    <div className="row mt-5">
                        ...
                        <div className="col-md-8">
                            <div className="row">
                                <div className="col-5">
                                    <div className="card" style={{ width: "18rem", background: 'gray', color: '#fff' }}>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <a style={{ textDecoration: 'none' }} href="/faculty/updateProfile"> <h5 style={{ width: 'max-content', height: '50px', background: 'White', borderRadius: '0px', color: 'gray', padding: '10px' }}>UPDATE PROFILE</h5></a>
